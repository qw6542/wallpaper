...
uniform sampler2D g_Texture2; // {"material":"ui_editor_properties_flow_phase","mode":"opacitymask","default":"util/white"}
uniform sampler2D g_Texture3; // {"material":"ui_editor_properties_opacity","mode":"opacitymask","combo":"MASK","default":"util/white"}
uniform float g_Time;

uniform float g_Speed; // {"material":"ui_editor_properties_speed","default":1,"range":[0.0, 10]}
uniform float g_Amp; // {"material":"ui_editor_properties_strength","default":0.1,"range":[0.01, 0.5]}
uniform vec2 g_Friction; // {"material":"ui_editor_properties_friction","default":"1 1","linked":true,"range":[0.01, 10.0]}
