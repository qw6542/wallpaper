...
uniform vec2 g_Offset; // {"material":"ui_editor_properties_offset","default":"0 0"}
uniform vec2 g_Scale; // {"material":"ui_editor_properties_scale","default":"1 1"}
uniform float g_Direction; // {"material":"ui_editor_properties_angle","default":0,"range":[0,6.28]}
