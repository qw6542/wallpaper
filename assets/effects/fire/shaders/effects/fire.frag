...
uniform float g_CloudFeather; // {"material":"ui_editor_properties_feather","default":0.5,"range":[0.01,1]}
...
uniform float g_Distortion; // {"material":"ui_editor_properties_distortion","default":1.0,"range":[0.01, 10]}
