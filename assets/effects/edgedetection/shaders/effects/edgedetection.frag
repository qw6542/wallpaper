...
uniform float g_BlendAlpha; // {"material":"ui_editor_properties_alpha","default":1,"range":[0.01,1]}
uniform vec3 g_OutlineColor1; // {"material":"ui_editor_properties_outline_color","default":"0 0 0","type":"color"}
uniform vec3 g_OutlineColor2; // {"material":"ui_editor_properties_outline_background","default":"1 1 1","type":"color"}
uniform float g_DetectionThreshold; // {"material":"ui_editor_properties_detection_threshold","default":0.5,"range":[0,5]}
uniform float g_DetectionMultiply; // {"material":"ui_editor_properties_detection_multiply","default":1,"range":[0,5]}
