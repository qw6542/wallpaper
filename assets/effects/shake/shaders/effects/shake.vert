...
uniform vec2 g_Bounds; // {"material":"ui_editor_properties_bounds","default":"0 1"}
...
uniform float g_AudioFrequencyMin; // {"material":"ui_editor_particle_element_frequency_min","default":0,"int":true,"range":[0,15]}
uniform float g_AudioFrequencyMax; // {"material":"ui_editor_particle_element_frequency_max","default":1,"int":true,"range":[0,15]}
uniform float g_AudioPower; // {"material":"ui_editor_properties_audio_exponent","default":1.0,"range":[0,4]}
uniform vec2 g_AudioBounds; // {"material":"ui_editor_properties_audio_bounds","default":"0.0 1.5"}
uniform float g_AudioMultiply; // {"material":"ui_editor_properties_audio_amount","default":1,"range":[0,2]}
