...
uniform vec3 g_NitroColor0; // {"material":"ui_editor_properties_color_start","default":"0 0.5 1","type":"color"}
...
uniform float g_NitroLOD; // {"material":"ui_editor_properties_smoothness","default":1,"range":[0.0, 5]}
