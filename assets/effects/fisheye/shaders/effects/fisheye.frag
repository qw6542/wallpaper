...
uniform float g_Size; // {"material":"ui_editor_properties_size","default":1,"range":[0.01, 1]}
uniform float g_Scale; // {"material":"ui_editor_properties_distortion","default":1,"range":[0, 2.5]}
uniform vec2 g_Center; // {"material":"ui_editor_properties_center","default":"0.5 0.5","position":true}
