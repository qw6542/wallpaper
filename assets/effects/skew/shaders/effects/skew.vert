...
uniform float g_Top; // {"material":"ui_editor_properties_top","default":0.0,"range":[-2,2]}
uniform float g_Bottom; // {"material":"ui_editor_properties_bottom","default":0.0,"range":[-2,2]}
uniform float g_Left; // {"material":"ui_editor_properties_left","default":0.0,"range":[-2,2]}
uniform float g_Right; // {"material":"ui_editor_properties_right","default":0.0,"range":[-2,2]}
