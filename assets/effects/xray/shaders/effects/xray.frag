...
uniform sampler2D g_Texture1; // {"material":"ui_editor_properties_blend_texture","default":"util/white"}
uniform sampler2D g_Texture2; // {"material":"ui_editor_properties_sprite","default":"particle/halo_6"}
