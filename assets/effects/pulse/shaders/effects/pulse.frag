...
#if MASK == 1
uniform sampler2D g_Texture2; // {"material":"ui_editor_properties_opacity_mask","mode":"opacitymask","combo":"MASK","default":"util/white","paintdefaultcolor":"0 0 0 1"}
#endif

uniform float g_Time;

uniform float g_PulseSpeed; // {"material":"ui_editor_properties_pulse_speed","default":3,"range":[0,10]}
uniform float g_PulsePhase; // {"material":"ui_editor_properties_pulse_phase","default":0,"range":[0,6.282]}
