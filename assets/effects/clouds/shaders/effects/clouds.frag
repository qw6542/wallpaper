...
uniform sampler2D g_Texture2; // {"material":"ui_editor_properties_opacity_mask","mode":"opacitymask","default":"util/white","combo":"MASK","paintdefaultcolor":"0 0 0 1"}
...
uniform float g_CloudFeather; // {"material":"ui_editor_properties_feather","default":0.5,"range":[0,1]}
...
#if SHADING == 100
uniform float g_CloudShading; // {"material":"ui_editor_properties_shading_amount","default":50,"range":[0,100]}
uniform float g_ShadingDirection; // {"material":"ui_editor_properties_shading_direction","default":3.141,"range":[0,6.28]}
#endif
...
uniform vec4 g_CloudSpeeds; // {"material":"ui_editor_properties_speed","default":"0.01 0.01 -0.02 -0.02"}
uniform vec4 g_CloudScales; // {"material":"ui_editor_properties_scale","default":"1.3 1.3 0.5 0.5"}
