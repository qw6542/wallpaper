...
uniform float g_KeyAlpha; // {"material":"ui_editor_properties_write_alpha","default":0,"range":[0,1]}
uniform float g_KeyFuzz; // {"material":"ui_editor_properties_fuzziness","default":0,"range":[0,3]}
uniform float g_KeyTolerance; // {"material":"ui_editor_properties_tolerance","default":0.1,"range":[0,3]}
uniform vec3 g_KeyColor; // {"material":"ui_editor_properties_color", "type": "color", "default":"1 1 1"}
