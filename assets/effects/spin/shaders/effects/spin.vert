...
uniform float g_Speed; // {"material":"ui_editor_properties_speed","default":1.0,"range":[-5,5]}
uniform vec2 g_SpinCenter; // {"material":"ui_editor_properties_center","default":"0.5 0.5","position":true}
uniform float g_Ratio; // {"material":"ui_editor_properties_ratio","default":1.0,"range":[0,10]}
uniform float g_Axis; // {"material":"ui_editor_properties_angle","default":0.0,"range":[0,3.141]}
